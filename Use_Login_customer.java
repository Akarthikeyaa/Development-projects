...
public class Use_Login_customer extends HttpServlet {
	private static final long serialVersionUID = 1L;
  
    public Use_Login_customer() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
             ...
             if (checkpassword(email,pass)) {
                 ...
                 response.sendRedirect("shop_display.jsp");
             } else {
	...
	{
		String query = "select count(*) from signup_customer where Password=\"" + pass +"\" and Email =\""+email+"\";";
