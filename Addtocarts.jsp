...
body{
background-image:url("https://img.freepik.com/premium-photo/shopping-concept-cartons-paper-boxes-red-shopping-cart-pink-background-online-shopping-consumers-can-shop-from-home-delivery-service-with-copy-space_9635-4021.jpg?w=2000");
}
.flex
{
display: flex;
...
<%
	if (msg == null) {
	%>
	<form action="Order_Now" id="checkout-form">
