...
%>
<div class=flexform>
<form action="Report" method="post" id="query-form" class="form">
	<div>
		<label for="start-date">Orders Dates</label> <input type="date"
...
<form action="Report_usr" method="post" id="user-form" class ="form1">
      <div>
		<label for="username">Customer emailid :</label> 
		<input type="text"
